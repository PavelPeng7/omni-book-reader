...
- Active feature plan: [`highlight-list-readability.md`](highlight-list-readability.md) for GitHub Issue #7.
- Latest completed release plan: [`../completed/release-0.9.5.md`](../completed/release-0.9.5.md).
